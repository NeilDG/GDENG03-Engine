...
bool Window::createWindow()
{
    ...
    this->windowHandle = ::CreateWindowEx(WS_EX_OVERLAPPEDWINDOW, wcx.lpszClassName, L"GDENG2-Engine App", WS_OVERLAPPEDWINDOW, CW_USEDEFAULT, CW_USEDEFAULT, 1440, 900, NULL, NULL, NULL, NULL);
    //show window
