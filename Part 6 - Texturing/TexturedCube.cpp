...
void TexturedCube::draw(int width, int height)
{
	ShaderNames shaderNames;
	DeviceContext* deviceContext = GraphicsEngine::getInstance()->getImmediateContext();
	Texture* woodTex = (Texture*) TextureManager::getInstance()->createTextureFromFile(L"D:/Documents/GithubProjects/GDENG2-Engine/Part 6 - Texturing/Assets/Textures/wood.jpg");
