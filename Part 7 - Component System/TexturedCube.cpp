...
void TexturedCube::draw(int width, int height)
{
	ShaderNames shaderNames;
	DeviceContext* deviceContext = GraphicsEngine::getInstance()->getImmediateContext();
	Texture* woodTex = (Texture*)TextureManager::getInstance()->createTextureFromFile(L"D:/Documents/GithubProjects/GDENG2-Engine/Part 7 - Component System/Assets/Textures/wood.jpg");
