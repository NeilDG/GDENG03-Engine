...
void AGameObject::setLocalMatrix(float matrix[16])
{
	...
	matrix4x4[0][1] = matrix[4];
	matrix4x4[0][2] = matrix[8];
	matrix4x4[0][3] = matrix[3];

	matrix4x4[1][0] = matrix[1];
	matrix4x4[1][1] = matrix[5];
	matrix4x4[1][2] = matrix[9];
	matrix4x4[1][3] = matrix[7];

	matrix4x4[2][0] = matrix[2];
	matrix4x4[2][1] = matrix[6];
	matrix4x4[2][2] = matrix[10];
	matrix4x4[2][3] = matrix[11];

	matrix4x4[3][0] = matrix[12];
	matrix4x4[3][1] = matrix[13] + 5.0f;
...
float* AGameObject::getLocalMatrix()
{
	...
	/*std::cout << "Matrix 4x4: " << matrix4x4[0] << "\n";
	std::cout << "Matrix 4x4: " << matrix4x4[1] << "\n";
	std::cout << "Matrix 4x4: " << matrix4x4[2] << "\n";
	std::cout << "Matrix 4x4: " << matrix4x4[3] << "\n";
	std::cout << "Matrix 4x4: " << matrix4x4[4] << "\n";
	std::cout << "Matrix 4x4: " << matrix4x4[5] << "\n";
	std::cout << "Matrix 4x4: " << matrix4x4[6] << "\n";
	std::cout << "Matrix 4x4: " << matrix4x4[7] << "\n";
	std::cout << "Matrix 4x4: " << matrix4x4[8] << "\n";
	std::cout << "Matrix 4x4: " << matrix4x4[9] << "\n";
	std::cout << "Matrix 4x4: " << matrix4x4[10] << "\n";
	std::cout << "Matrix 4x4: " << matrix4x4[11] << "\n";
	std::cout << "Matrix 4x4: " << matrix4x4[12] << "\n";
	std::cout << "Matrix 4x4: " << matrix4x4[13] << "\n";
	std::cout << "Matrix 4x4: " << matrix4x4[14] << "\n";
	std::cout << "Matrix 4x4: " << matrix4x4[15] << "\n";*/
...
float* AGameObject::getPhysicsLocalMatrix()
{
	...
	matrix4x4[5] = 1.0f;
	matrix4x4[10] = 1.0f;
	matrix4x4[12] = this->localPosition.getX(); matrix4x4[13] = this->localPosition.getY();
	matrix4x4[14] = this->localPosition.getZ(); matrix4x4[15] = 1.0;
